;; -*- emacs-lisp -*-
;; @@ ETAGS
;; Time-stamp: <2016-10-17 15:08 akira.masuda>
;;
...
(setq tags-table-list
	  '("~/.emacs.d/etags/elisp_TAGS"
		"~/.emacs.d/etags/reuse_tool_TAGS"
		"~/.emacs.d/etags/reuse_web_TAGS"
...
;; create etags/reuse_TAGS
(defun ma:create-reuse-etags ()
  (interactive)
  (ma:create-etags "reusephp_etags.bat"))
